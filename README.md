...
# How to set up my dotfiles? **_(YOU MUST BE ON NVIM version 0.12.3)_**
...
### Pre Requisite that should be installed
...
For nvim-treesitter you need to have the latest version of tree-sitter-cli installed (npm has the latest version)
